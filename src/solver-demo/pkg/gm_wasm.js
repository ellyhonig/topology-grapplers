...
export class Engine {
    ...
    jointNames() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.engine_jointNames(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    loadDatabase(text) {
        ...
        try {
            ...
            const ret = wasm.engine_loadDatabase(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    loadEntry(index) {
        const ret = wasm.engine_loadEntry(this.__wbg_ptr, index);
        if (ret[1]) {
    ...
    loadPose(data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.engine_loadPose(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    pose() {
        const ret = wasm.engine_pose(this.__wbg_ptr);
    ...
    setConfig(json) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.engine_setConfig(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    setPins(data) {
        const ptr0 = passArrayF64ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.engine_setPins(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {Float64Array} effectors
     * @param {number} dt
     * @returns {Float64Array}
     */
    step(effectors, dt) {
        const ptr0 = passArrayF64ToWasm0(effectors, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.engine_step(this.__wbg_ptr, ptr0, len0, dt);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
    ...
    topologySummary() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.engine_topologySummary(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    validate() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.engine_validate(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gm_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
