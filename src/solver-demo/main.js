...
async function connectTrackerBridge() {
	...
	// A page served from localhost can connect to the loopback WebSocket
	// directly. The preliminary fetch is only needed by hosted Chrome builds to
	// request Private Network Access, and used to be able to wait forever.
